        ...
        <section id="content">
            ...
            <main>
                ...
                <div class="table-data">
                    <div class="order">
                        <a class="addButton" href="javascript:void(0);" onclick="showForm('add', 'mitra', null)">
                                ...
                                columnDefs: [
                                    {
                                        ...
                                        render: function(data, type, row) {
                                            let img = '<img src=\'../storage/mitra/'+data+'\'>';
                                            return img;
                                        }
                                    },
                                    {
                                        ...
                                        targets: 2,
                                        render: function(data, type, row) {
                                            let btn = '<a href=\'javascript:void(0);\' onclick=\'showForm("update", "mitra", '+data+')\'><i class=\'bx bxs-edit\'></i></a> <a href=\'javascript:void(0);\' onclick=\'showForm("delete", "mitra", '+data+')\'><i class=\'bx bxs-trash\'></i></a> <a href=\'javascript:void(0);\' onclick=\'showForm("view", "mitra", '+data+')\'><i class=\'bx bx-target-lock\'></i></a>';
                                            return btn;
                                        }
                                    },
                                    {
